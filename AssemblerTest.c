...
void testHelperPhase1(struct ArrayList *input, struct ArrayList *expectedP1) {
  ...
  // same length?
  printf("size of expected: %d\n", size(expectedP1));
  printf("size of tals: %d\n", size(tals));
  assert(size(expectedP1) == size(tals));
  // same objects?
  for(int i = 0; i < size(expectedP1); i++){
    printf("expected instruction id = : %d\n", get(expectedP1, i).instruction_id);
    printf("expected rd = : %d\n", get(expectedP1, i).rd);
    printf("expected rs = : %d\n", get(expectedP1, i).rs);
    printf("expected rt = : %d\n", get(expectedP1, i).rt);
    printf("expected jump = : %d\n", get(expectedP1, i).jump_address);
    printf("expected shift = : %d\n", get(expectedP1, i).shift_amount);
    printf("expected immediate = : %d\n", get(expectedP1, i).immediate);
    printf("expected label = : %s\n", get(expectedP1, i).label);
    printf("expected branch label = : %s\n", get(expectedP1, i).branch_label);
   
    printf("tals instruction id = : %d\n", get(tals, i).instruction_id);
    printf("tals rd = : %d\n", get(tals, i).rd);
    printf("tals rs = : %d\n", get(tals, i).rs);
    printf("tals rt = : %d\n", get(tals, i).rt);
    printf("tals jump = : %d\n", get(tals, i).jump_address);
    printf("tals shift = : %d\n", get(tals, i).shift_amount);
    printf("tals immediate = : %d\n", get(tals, i).immediate);
    printf("tals label = : %s\n", get(tals, i).label);
    printf("tals branch label = : %s\n", get(tals, i).branch_label);
...
void testHelperPhase2(struct ArrayList *expectedP1, struct ArrayList *expectedP2) {
  ...
  for(int i = 0; i < size(expectedP2); i++){
    /* printf("expected instruction id = : %d\n", get(expectedP2, i).instruction_id); */
    /* printf("expected rd = : %d\n", get(expectedP2, i).rd); */
    /* printf("expected rs = : %d\n", get(expectedP2, i).rs); */
    /* printf("expected rt = : %d\n", get(expectedP2, i).rt); */
    /* printf("expected jump = : %d\n", get(expectedP2, i).jump_address); */
    /* printf("expected shift = : %d\n", get(expectedP2, i).shift_amount); */
    /* printf("expected immediate = : %d\n", get(expectedP2, i).immediate); */
    /* printf("expected label = : %s\n", get(expectedP2, i).label); */
    /* printf("expected branch label = : %s\n", get(expectedP2, i).branch_label); */
   
    /* printf("rtals instruction id = : %d\n", get(resolved_tals, i).instruction_id); */
    /* printf("rtals rd = : %d\n", get(resolved_tals, i).rd); */
    /* printf("rtals rs = : %d\n", get(resolved_tals, i).rs); */
    /* printf("rtals rt = : %d\n", get(resolved_tals, i).rt); */
    /* printf("rtals jump = : %d\n", get(resolved_tals, i).jump_address); */
    /* printf("rtals shift = : %d\n", get(resolved_tals, i).shift_amount); */
    /* printf("rtals immediate = : %d\n", get(resolved_tals, i).immediate); */
    /* printf("rtals label = : %s\n", get(resolved_tals, i).label); */
    /* printf("rtals branch label = : %s\n", get(resolved_tals, i).branch_label); */
...
void testHelperPhase3(struct ArrayList *expectedP2, uint32_t expectedP3[]) {
  ...
  for(int i = 0; i < size(expectedP2); i++){
    ...
    printf("expected binary = : %d\n", expectedP3[i]);
    printf("translated binary = : %u\n", translated[i]);
...
void test2Phase1() {
  ...
  struct Instruction input[4] = {
    ...
    // bge $t0, $t1, Label1
    CreateBge(8, 9, "label1"),
    // bge $t1, $t0, Label2
    CreateBge(9, 8, "label2")
  };
...
void test4Phase1() {
  printf("-------------TESTING TEST 4 PHASE 1---------------");
  struct Instruction input[6] = {
    CreateAddiu(19, 0, 22),
    CreateAddiu(9,0,10),
    CreateBge(9,19, "label4"),
    CreateOr(20, 19, 9),
